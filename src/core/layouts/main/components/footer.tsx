import { Box, VStack, Button, Icon, Text, Flex, HStack } from "@chakra-ui/react";
...
export function Footer(props: NavBarProps) {
  ...
  return (
    <Box width="full" height="100px" backgroundColor={"black"}
    borderTop="1px solid #383838" padding={15}>
